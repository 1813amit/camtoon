...
export default function Tool() {
    ...
    const notify = () => toast.warn("Start by taking or uploading a photo.");
            ...
            <main>
                <DashboardLayout content={
                    <div className="md:flex md:h-full">
                        ...
                        <div className="relative xl:w-96 lg:w-80 md:w-72 w-full h-64 bg-gray-900">
