                                    ...
                                    <li onClick={() => handleActiveGuide("launching")} className="flex justify-between gap-2 w-full p-8 bg-gray-100 rounded cursor-pointer">
                                        <div>
                                            ...
                                            {activeGuide === "launching" && <p className="text-gray-700 mt-2">
                                                Click &quot;Launch Tool&quot; inside the menu, or portrait tool.  
                                            </p>}
                                        </div>
                                    ...
                                    <li onClick={() => handleActiveGuide("uploading")} className="flex justify-between gap-2 w-full p-8 bg-gray-100 rounded cursor-pointer">
                                        <div>
                                            ...
                                            {activeGuide === "uploading" && <p className="text-gray-700 mt-2">
                                                Uploading a photo to Camtoon is possible in two ways.  From the tool, drag a photo to the &quot;upload&quot; box, or click the section to open your device storage to choose a photo.
                                            </p>}
                                        </div>
                                        <div className="!w-6 !h-6">
                                    ...
                                    <li onClick={() => handleActiveGuide("filters")} className="flex justify-between gap-2 w-full p-8 bg-gray-100 rounded cursor-pointer">
                                        <div>
                                            ...
                                            {activeGuide === "filters" && <p className="text-gray-700 mt-2">
                                                Camtoon applies a filter automatically when you upload a photo.  Preview the result right away before downloading.
                                            </p>}
                                        </div>
                                        <div className="!w-6 !h-6">
                                    ...
                                    <li onClick={() => handleActiveGuide("export")} className="flex justify-between gap-2 w-full p-8 bg-gray-100 rounded cursor-pointer">
                                        <div>
                                            ...
                                            {activeGuide === "export" && <p className="text-gray-700 mt-2">
                                                Once you have uploaded a photo, and configured the settings, you can now click &quot;generate&quot;.  This will apply the Camtoon cartoonify filter and return the new photo, downloaded to your device.
                                            </p>}
                                        </div>
                                        <div className="!w-6 !h-6">
